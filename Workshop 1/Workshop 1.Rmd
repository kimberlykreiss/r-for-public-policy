...
+ y is the dependent variable and the x variables are the dependent variables 
...
+ Stargazer is an R package that creates LATEX code, HTML code and ASCII text for well-formatted regression tables, with multiple models side-by-side, and summary stats, etc.
